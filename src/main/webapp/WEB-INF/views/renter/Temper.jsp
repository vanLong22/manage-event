...
<body>
        ...
        <div class="main-content">
            ...
            <div id="events" class="content-section">
                ...
                <div class="filter-section">
                    <!-- Add filters above the section-header or table -->
                    <div class="filters-container" style="margin-bottom: 20px; display: flex; gap: 15px;">
                        ...
                        <div class="form-group">
                            <label for="filter-privacy">Quyền riêng tư</label>
                        ...
                        <div class="form-group">
                            <label for="filter-category">Loại sự kiện</label>
                            <select id="filter-category">
                                <option value="">Tất cả</option>
                                <!-- Load categories dynamically from ${eventTypes} or API -->
    ...
    $(document).ready(function() {
        ...
        */
        ...
        // Function to load events with filters
        function loadEventsWithFilters() {
            var keyword = $('#filter-keyword').val();
            var status = $('#filter-status').val();
            var privacy = $('#filter-privacy').val();
            ...
            $.get('/participant/api/events', {  
                ...
                alert('Lỗi khi tải sự kiện với bộ lọc!');
            });
        }

        // Attach event to apply filters button
