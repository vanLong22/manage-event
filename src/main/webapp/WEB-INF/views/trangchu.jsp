        ...
        <div class="container">
            <nav class="navbar">
                ...
                <div class="auth-section" id="authSection">
                    ...
                    <div id="guestButtons">
                        <a href="${pageContext.request.contextPath}/login" class="btn btn-outline btn-login">
                            <i class="fas fa-sign-in-alt"></i> Đăng nhập
                        </a>
                        <a href="${pageContext.request.contextPath}/login" class="btn btn-primary btn-register">
