...
public String showAdminDashboard(Model model) {
    ...
    // Trả về tên view (VD: admin/dashboard.jsp)
    return "admin/admin";
}
    ...
    public ResponseEntity<Map<String, Object>> approveEvent(@PathVariable Long id) {
        Map<String, Object> response = new HashMap<>();
        
        Event event = eventService.getEventById(id);
        if (event != null) {
            event.setTrangThai("DangDienRa");
            // You'll need to add update method in EventService
            response.put("success", true);
    ...
    public ResponseEntity<Map<String, Object>> deleteEvent(@PathVariable Long id) {
        ...
        try {
            ...
            response.put("success", false);
            response.put("message", "Lỗi khi xóa sự kiện");
        }
    ...
    public ResponseEntity<Map<String, Object>> getAnalytics() {
        ...
        data.put("pendingEvents", allEvents.stream()
            .filter(e -> "SapDienRa".equals(e.getTrangThai()))
            .count());
        data.put("avgParticipation", 85); // Placeholder
    ...
    public ResponseEntity<Map<String, Object>> saveSuggestionConfig(@RequestBody Map<String, Object> config) {
        Map<String, Object> response = new HashMap<>();
        response.put("success", true);
    ...
    public ResponseEntity<Map<String, Object>> saveSystemSettings(@RequestBody Map<String, String> settings) {
        Map<String, Object> response = new HashMap<>();
        response.put("success", true);
